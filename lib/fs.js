...
exports.lstatTry = async function lstatTry(...args) {
  try {
    return await exports.lstat(...args);
  } catch (e) {
    if (e.code === 'ENOENT')
      return null;
    throw e;
...
exports.lstatTrySync = function lstatTrySync(...args) {
  try {
    return exports.lstatSync(...args);
  } catch (e) {
    if (e.code === 'ENOENT')
      return null;
    throw e;
...
exports.statTry = async function statTry(...args) {
  try {
    return await exports.stat(...args);
  } catch (e) {
    if (e.code === 'ENOENT')
      return null;
    throw e;
...
exports.statTrySync = function statTrySync(...args) {
  try {
    return exports.statSync(...args);
  } catch (e) {
    if (e.code === 'ENOENT')
      return null;
    throw e;
